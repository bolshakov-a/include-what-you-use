...
// TODO(bolshakov): resugar constructed parameter of I1_TemplateClass
// constructor to typedef type somehow.
// IWYU: I1_Typedef_Class is...*badinc-i1.h
// IWYU: I1_TemplateClass is...*badinc-i1.h
...
int main() {
  ...
  // since it's just a single file. But it is reported because the template
  // defining file doesn't include the function defining file directly.
  // In the second two cases, we can't know the file required until now (when
